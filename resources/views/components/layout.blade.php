...
<html lang="en">
      ...
      <body id="page-top">
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
          <div class="container px-4 px-lg-5">
              <a href="/">
                <img src="{{ asset('images/transfer.png') }}"  width="50" height="50" class="d-inline-block align-top">
              </a>
  ...
  <div class="container px-4 px-lg-5"><div class="small text-center text-muted">Copyright &copy; 2023 - Transformation</div></div>
</footer>
<!-- Bootstrap core JS-->
